...
?>
        ...
        <div class="section">
                <div class="contenedor">  
                  <div class="row"> <!--Fila de títulos-->
                      
                          <div class="col s5 card-panel">
                              
                              <blockquote class="promociones"><!--Para l barra de color a la izquera del texto-->
                                  <!--Para que el texto tenga el fuente que si visuliza en este ejemplo-->
                                  <p class="flow-text"> <h4 class="">Componentes de Computadoras</h4></p>          
                              </blockquote>
                          </div>
                      ...
                      <div class="col s5 card-panel">
                              ...
                              <blockquote class="nuevos productos"><!--Para la barra de color a la izquera del texto-->
                                  <!--Para que el texto tenga el fuente que si visuliza en este ejemplo-->
                                  <p class="flow-text"> <h4 class="">Componentes de Smartphone</h4></p>          
                              </blockquote>
                      </div>
                          
                  </div><!--Fin de los títulos-->
      
                  <div class="row"><!--Primera fila de articulos-->              
                    ...
                    <div class="col s2">
                        <div class="card">
                            ...
                            <div class="card-reveal">
                              <span class="card-title blue-text text-darken-4">Card Title<i class="material-icons right">close</i></span>
                  ...
                  </div><!--Fin de la primera fila de articulos-->
